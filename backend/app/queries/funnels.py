...
Ported verbatim from src/queries/funnels.ts.
"""
...
async def get_funnel(
    ...
    # Final query: count at each step
    selects = ", ".join(
    ...
    for i, s in enumerate(steps):
        ...
        conversion_rate = (
            100.0
            if i == 0
            else ((visitors / prev_visitors) * 100 if prev_visitors > 0 else 0)
        )
