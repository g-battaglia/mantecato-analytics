...
Privacy-first aggregate-only mode: only pageview metrics are supported.
...
Deprecated modules (no-op stubs):
    sessions, retention, funnels, journeys, revenue, sources, events, engagement, filter_values

These features require persistent identifiers (sessions, visitors) which
violate the privacy-first mandate in PLAN.md.
"""
