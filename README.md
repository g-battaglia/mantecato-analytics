...
<p align="center">
  ...
  Cookie-free tracking, self-hostable infrastructure, privacy-conscious analytics.<br>
  AI-native — built with Django + HTMX.
</p>
...
| | |
|---|---|
| 🔒 **Privacy-conscious** | Cookie-free tracking, self-hostable infrastructure, bot filtering, and controls for data minimization. Review local privacy and cookie requirements for your deployment |
...
That's it. Pageview and event data starts flowing into your dashboard instantly. No build step, no npm install, no configuration files.

Mantecato is not a consent-management platform and this README does not make a
blanket legal-compliance claim. Operators are responsible for configuring their
deployment, notices, retention, hosting and data-processing arrangements for the
jurisdictions that apply to them.
